                        ...
                        <a v-for="book in resultQuery" :key="book.id"
                            ...
                            <div class="mt-4">
                                <span v-if="countAvailableCopies(book) > 0"
                                    class="py-1 px-1.5 inline-flex items-center gap-x-1 text-xs font-medium bg-green-100 text-custom-blue rounded-full dark:bg-red-500/10 dark:text-custom-blue">
